      ...
      <section className="py-12 bg-secondary">
        <div className="container-wide">
          ...
          <div className="max-w-4xl">
            <h1 className="text-3xl lg:text-4xl font-bold text-secondary-foreground mb-6">About Sigma Aircons</h1>
            ...
            <h2 className="text-2xl font-bold text-secondary-foreground mb-6">Our Mission</h2>
            <p className="text-muted-foreground mb-8">
            ...
            <h2 className="text-2xl font-bold text-secondary-foreground mb-6">Why People Trust Us</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
              {[
                ...
                <div key={i} className="flex items-start gap-4 p-4 rounded-lg bg-muted border border-border">
            ...
            <div className="bg-primary rounded-lg p-8 text-center">
              <h2 className="text-2xl font-bold text-primary-foreground mb-3">Ready to Experience the Best AC Service?</h2>
              <p className="text-primary-foreground/80 mb-6">Call us now for fast, professional AC service in Vadodara.</p>
