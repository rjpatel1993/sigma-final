      ...
      <section className="py-12 bg-secondary">
        <div className="container-wide">
          ...
          <div className="max-w-4xl">
            <h1 className="text-3xl lg:text-4xl font-bold text-secondary-foreground mb-4">
            ...
            {/* Benefits */}
            <h2 className="text-2xl font-bold text-secondary-foreground mb-4">Why Choose Sigma Aircons in {area.name}?</h2>
            ...
            <h2 className="text-2xl font-bold text-secondary-foreground mb-4">Other AC Services in {area.name}</h2>
            <div className="flex flex-wrap gap-2 mb-12">
              {SERVICES.filter(s => s.slug !== service.slug).map((s) => (
                <Link key={s.slug} to={`/service/${s.slug}/${area.slug}/`} className="px-3 py-1.5 rounded-md bg-muted border border-border text-sm text-muted-foreground hover:text-primary hover:border-primary/50 transition-colors">
                  {s.name}
                </Link>
              ))}
            </div>
            ...
            {/* FAQ */}
            <h2 className="text-2xl font-bold text-secondary-foreground mb-4">{service.name} in {area.name} — FAQ</h2>
